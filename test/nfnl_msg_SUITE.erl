...
batch_begin_format(_) ->
    ...
    <<20:32/little, Type:16/little, 1:16/little,
      42:32/little, 0:32/little,
      0:8, 0:8, 10:16/big>> = Msg,
    %% Type = (0 << 8) | 16 = 16
    ?assertEqual(16, Type).
...
build_hdr_newtable(_) ->
    ...
    <<Len:32/little, Type:16/little, 16#0405:16/little,
      100:32/little, 0:32/little,
      1:8, 0:8, 0:16/big,
      _Attrs/binary>> = Msg,
